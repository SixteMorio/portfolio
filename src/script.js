...
const circles = [
  ...
  },
  {
    ...
    message: "Bravo vous avez fini !</br>Ceci étant quelques projets je serais ravi de vous rencontrez afin d'en discuter où de vous en présentez d'autres !</br></br></br>Copyright </br> - Wave by Poly by Google [CC - BY](<https://creativecommons.org/licenses/by/3.0/>) via Poly Pizza (<https://poly.pizza/m/6mpwUZqCgzy>)</br> - Ocean by Poly by Google [CC- BY](<https://creativecommons.org/licenses/by/3.0/>) via Poly Pizza (<https://poly.pizza/m/faUostvShTI>)"
  }
];
